...
# Kernel addresses (from vendor_boot.img header)
...
# Kernel modules — vendor ramdisk (loaded in vendor_boot)
...
# Kernel modules — installed to vendor/lib/modules
BOARD_VENDOR_KERNEL_MODULES_LOAD := $(strip $(shell cat $(KERNEL_PATH)/vendor_modules/modules.load))
BOARD_VENDOR_KERNEL_MODULES := $(wildcard $(KERNEL_PATH)/vendor_modules/*.ko)
...
# Workaround for Soong namespace generator
TARGET_KERNEL_SOURCE := $(KERNEL_PATH)/kernel-headers

# OTA assert
TARGET_OTA_ASSERT_DEVICE := KJ7,TECNO-KJ7,tecno-kj7,kj7
